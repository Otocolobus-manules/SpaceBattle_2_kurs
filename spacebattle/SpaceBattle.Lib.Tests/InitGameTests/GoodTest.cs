public class GenObjectTest
{
    ...
    public void get_list_of_IUObject_test()
    {
        ...
        Assert.Equal(((List<IUObject>)test_iterator._position).Count(), 3);
    }
    ...
    public void set_fuel_list_of_IUObject_test()
    {
        ...
        {
            ((List<IUObject>)x)[0].SetProperty("fuel", It.IsAny<Object>());
        ...
        var test_iterator_set_fuel = new Iterator(test_iterator_create_iuobject_list._position, set_fuel);
